...
\newcommand\centerimage{Images/Crew_Dragon_Demo-2_Patch.png}
...
\newcommand\titletext{
SpaceX Crew Dragon Demo-2 Bingo
...
\newcommand{\freespace}{
	\filldraw[fill=white!90, draw=black] ($(\col,-\row)-(1,1)$) rectangle ($(\col,-\row)$) ;
